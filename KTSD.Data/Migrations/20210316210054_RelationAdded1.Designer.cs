...
namespace KTSD.Data.Migrations
{
    ...
    [Migration("20210316210054_RelationAdded1")]
    partial class RelationAdded1
    {
            ...
            modelBuilder.Entity("KTSD.Core.Models.Announcement", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 3, 17, 0, 0, 54, 582, DateTimeKind.Local).AddTicks(5760));
            ...
            modelBuilder.Entity("KTSD.Core.Models.Event", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 0, 0, 54, 596, DateTimeKind.Local).AddTicks(1280));
            ...
            modelBuilder.Entity("KTSD.Core.Models.File", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 0, 0, 54, 586, DateTimeKind.Local).AddTicks(5990));
            ...
            modelBuilder.Entity("KTSD.Core.Models.NavMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 0, 0, 54, 578, DateTimeKind.Local).AddTicks(4550));
            ...
            modelBuilder.Entity("KTSD.Core.Models.Page", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 0, 0, 54, 574, DateTimeKind.Local).AddTicks(8960));
            ...
            modelBuilder.Entity("KTSD.Core.Models.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 0, 0, 54, 591, DateTimeKind.Local).AddTicks(380));
            ...
            modelBuilder.Entity("KTSD.Core.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 17, 0, 0, 54, 558, DateTimeKind.Local).AddTicks(420));
