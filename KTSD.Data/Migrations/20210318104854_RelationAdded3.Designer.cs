...
namespace KTSD.Data.Migrations
{
    ...
    [Migration("20210318104854_RelationAdded3")]
    partial class RelationAdded3
    {
            ...
            modelBuilder.Entity("KTSD.Core.Models.Announcement", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 3, 18, 13, 48, 54, 478, DateTimeKind.Local).AddTicks(7420));
            ...
            modelBuilder.Entity("KTSD.Core.Models.Event", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 18, 13, 48, 54, 492, DateTimeKind.Local).AddTicks(1760));
            ...
            modelBuilder.Entity("KTSD.Core.Models.File", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 18, 13, 48, 54, 481, DateTimeKind.Local).AddTicks(9260));
            ...
            modelBuilder.Entity("KTSD.Core.Models.NavMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 18, 13, 48, 54, 474, DateTimeKind.Local).AddTicks(3420));
            ...
            modelBuilder.Entity("KTSD.Core.Models.Page", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 18, 13, 48, 54, 469, DateTimeKind.Local).AddTicks(6560));
            ...
            modelBuilder.Entity("KTSD.Core.Models.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 18, 13, 48, 54, 486, DateTimeKind.Local).AddTicks(6030));
            ...
            modelBuilder.Entity("KTSD.Core.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 18, 13, 48, 54, 452, DateTimeKind.Local).AddTicks(8870));
